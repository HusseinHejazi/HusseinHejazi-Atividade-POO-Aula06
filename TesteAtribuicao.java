...
public class TesteAtribuicao{
   public static void main(String[] args){
      ...
      boolean pratica = Boolean.parseBoolean(JOptionPane.showInputDialog("É pratica?true/false")); // como coloquei na classe Disciplina "boolean = false", sempre vai dar false.
